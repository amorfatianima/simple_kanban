...
var SimpleKanbanPlugin = class extends import_obsidian.Plugin {
  ...
  async onload() {
    ...
    (0, import_obsidian.addIcon)(
      ICON_ID,
      `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><text x="12" y="16" font-size="14" text-anchor="middle">\u{1F5C2}\uFE0F</text></svg>`
    );
